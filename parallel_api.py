...
from anuga_parallel.parallel_abstraction import (print0, mpiWrapper,
  pypar_available, size, rank, get_processor_name,
  barrier, send, receive, finalize)
    ...
    if myid == 0:
        ...
        for p in xrange(1, numprocs):
            ...
            send((domain_name, domain_dir, domain_store, \
                  domain_smooth, domain_reduction, \
